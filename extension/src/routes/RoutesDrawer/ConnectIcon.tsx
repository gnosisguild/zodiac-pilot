...
export const RouteIcon: IconType = ({ size, color, title, role }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 16 16" role={role} fill="none">
    {title && <title>{title}</title>}
    <g clipPath="url(#clip0_169_6271)">
      <path opacity="0.2" d="M12.5 14.5C13.3284 14.5 14 13.8284 14 13C14 12.1716 13.3284 11.5 12.5 11.5C11.6716 11.5 11 12.1716 11 13C11 13.8284 11.6716 14.5 12.5 14.5Z" fill={color} />
      <path d="M12.5 14.5C13.3284 14.5 14 13.8284 14 13C14 12.1716 13.3284 11.5 12.5 11.5C11.6716 11.5 11 12.1716 11 13C11 13.8284 11.6716 14.5 12.5 14.5Z" stroke={color} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M4.5 4H10.5C11.0304 4 11.5391 4.21071 11.9142 4.58579C12.2893 4.96086 12.5 5.46957 12.5 6C12.5 6.53043 12.2893 7.03914 11.9142 7.41421C11.5391 7.78929 11.0304 8 10.5 8H4.5C3.83696 8 3.20107 8.26339 2.73223 8.73223C2.26339 9.20107 2 9.83696 2 10.5C2 11.163 2.26339 11.7989 2.73223 12.2678C3.20107 12.7366 3.83696 13 4.5 13H11" stroke={color} strokeLinecap="round" strokeLinejoin="round" />
    </g>
    <defs>
