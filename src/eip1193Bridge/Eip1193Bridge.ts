...
// Taken from https://github.com/ethers-io/ethers.js/blob/master/packages/experimental/src.ts/eip1193-bridge.ts
// MIT License - Copyright (c) 2019 Richard Moore
// export class Eip1193BridgeHost extends EventEmitter {
