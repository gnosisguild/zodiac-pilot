...
export const PrimaryButton = ({
  ...
  <BaseButton
    ...
    className={cn(
      ...
      style === 'regular' &&
        'border-transparent bg-zinc-900 text-zinc-50 focus:border-white focus:ring-indigo-600 enabled:hover:bg-zinc-800 dark:bg-zinc-200 dark:text-zinc-900 dark:focus:border-transparent dark:focus:ring-teal-400 dark:enabled:hover:bg-zinc-50',
      style === 'contrast' &&
...
export const PrimaryLinkButton = ({
  ...
  <BaseLinkButton
    ...
    className={cn(
      'font-bold ring-2 ring-transparent',
      style === 'regular' &&
        'border-transparent bg-zinc-900 text-zinc-50 hover:bg-zinc-800 focus:border-white focus:ring-indigo-600 dark:bg-zinc-200 dark:text-zinc-900 dark:hover:bg-zinc-50 dark:focus:border-transparent dark:focus:ring-teal-400',
      style === 'contrast' &&
