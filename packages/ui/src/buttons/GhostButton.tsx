...
export const GhostButton = ({
  ...
  <BaseButton
    ...
    className={classNames(
      ...
      style === 'contrast' &&
        'text-zinc-400 focus:bg-indigo-600 focus:text-indigo-100 enabled:hover:bg-zinc-800 enabled:hover:text-zinc-300 dark:text-zinc-500 dark:focus:bg-teal-400 dark:focus:text-teal-900 dark:enabled:hover:bg-zinc-200 dark:enabled:hover:text-zinc-700',
      style === 'critical' &&
...
export const GhostLinkButton = ({
  ...
  <BaseLinkButton
    ...
    className={classNames(
      ...
      style === 'contrast' &&
        'text-zinc-400 hover:bg-zinc-800 hover:text-zinc-300 focus:bg-indigo-600 focus:text-indigo-100 dark:text-zinc-500 dark:hover:bg-zinc-200 dark:hover:text-zinc-700 dark:focus:bg-teal-400 dark:focus:text-teal-900',
      style === 'critical' &&
        'text-red-500 hover:bg-red-900 hover:text-red-400 focus:bg-red-600 focus:text-white dark:focus:bg-red-700 dark:focus:text-red-100',
    )}
  />
)
